...
class NICEModel(nn.Module):
    ...
    * a diagonal scaling matrix output layer
    ...
    def __init__(self, input_dim, hidden_dim, num_layers,norm=True):
        ...
        self.layer1 = DoubleAffineLayer(input_dim, 'odd', hidden_dim, num_layers,norm)
        self.layer2 = DoubleAffineLayer(input_dim, 'even', hidden_dim, num_layers,norm)
        self.layer3 = DoubleAffineLayer(input_dim, 'odd', hidden_dim, num_layers,norm)
        self.layer4 = DoubleAffineLayer(input_dim, 'even', hidden_dim, num_layers,norm)
    ...
    def inverse(self, ys,train=False):
...
class NICEAdditiveModel(nn.Module):
    """
    Replication of model from the paper:
      "Nonlinear Independent Components Estimation",
      Laurent Dinh, David Krueger, Yoshua Bengio (2014)
    ...
    * a diagonal scaling matrix output layer
    ...
    def __init__(self, input_dim, hidden_dim, num_layers,norm=True):
        ...
        self.input_dim = input_dim
        half_dim = int(input_dim / 2)
        self.layer1 = AdditiveCouplingLayer(input_dim, 'odd', _build_relu_network(half_dim, hidden_dim, num_layers,norm))
        self.layer2 = AdditiveCouplingLayer(input_dim, 'even', _build_relu_network(half_dim, hidden_dim, num_layers,norm))
        self.layer3 = AdditiveCouplingLayer(input_dim, 'odd', _build_relu_network(half_dim, hidden_dim, num_layers,norm))
        self.layer4 = AdditiveCouplingLayer(input_dim, 'even', _build_relu_network(half_dim, hidden_dim, num_layers,norm))
        self.scaling_diag = nn.Parameter(torch.ones(input_dim))
